...
1. The navigation buttons.<br>    1.1 Login<br>    1.2 Git<br>    1.3 New batch<br>    1.4 QuickStatements 3.0
2. The new batch form<br>    2.1 Command format<br>        - CSV command format<br>        - V1 command format<br>    2.2 Custom bacth name<br>    2.3 Text area for entering commands<br>    2.4  Error message
